...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'theme.emerald': 'Boreal Emerald',
    'theme.corporate': 'Modern Professional',
    'theme.academic': 'Classic Academic (Light)',
    'theme.corporatelight': 'Corporate Slate (Light)',
  ...
  fr: {
    ...
    'theme.academic': 'Académique Classique (Clair)',
    'theme.corporatelight': 'Corporatif Ardoise (Clair)',
