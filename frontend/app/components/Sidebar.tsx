    ...
    <aside className="w-64 glass-panel m-4 flex flex-col justify-between hidden md:flex shrink-0 relative overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        <button
          ...
          className="w-full flex items-center justify-between transition-all p-3 rounded-xl text-foreground/80 hover:text-primary hover:bg-primary/10 border border-card-border"
        >
