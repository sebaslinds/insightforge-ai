...
async def generate_insight(payload: dict, language: str = "en") -> str:
    ...
    try:
        ...
        system_prompt = (
            ...
            "IMPORTANT: \n"
            "1. Utilise TOUJOURS les chiffres réels du 'data_summary' fournis. Ne les invente JAMAIS.\n"
            ...
            "3. COHÉRENCE COHORTE : Si la question porte sur une cohorte spécifique (ex: W13), précise bien que tu analyses cet échantillon. Si des données globales (global_stats) sont fournies dans le payload, utilise-les pour mettre en perspective les chiffres de la cohorte par rapport à l'ensemble du parc utilisateurs.\n"
            ...
            "6. ÉLÉGANCE LINGUISTIQUE : Interdiction de citer '30 et 7 jours' ensemble si les deux sont à 0. Pour les utilisateurs inactifs, dis simplement 'aucune activité depuis plus d'un mois' ou 'inactivité totale'. Utilise un ton pro et naturel.\n"
            "7. Explique l'impact business court (ex: pourquoi le churn est élevé).\n\n"
            ...
            "IMPORTANT: \n"
            "1. ALWAYS use the real figures from 'data_summary'. NEVER invent them.\n"
            "2. SYSTEMATICALLY include a Recharts graph via a JSON block if the data allows.\n"
            "3. COHORT CONSISTENCY: If asked about a specific cohort (e.g., W18), clarify that you are analyzing this specific group. If global statistics (global_stats) are provided, use them to put the cohort numbers into perspective against the total user base.\n"
            ...
            "6. LINGUISTIC NATURALNESS: Avoid awkward phrasing like 'in the last 30 and 7 days'. Use natural language (e.g., 'no activity for over a month'). If 30-day activity is 0, ignore the 7-day stat.\n"
            "7. Explain short business impact (e.g., why churn is high).\n\n"
